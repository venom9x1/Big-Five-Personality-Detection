...
export default class PersonCard extends React.Component {
	...
	this.round_probs = this.round_probs.bind(this);
	this.round_scores = this.round_scores.bind(this);
	this.round_percs = this.round_percs.bind(this);
	this.handleCompare = this.handleCompare.bind(this);
	this.annonymizeNames = this.annonymizeNames.bind(this);
